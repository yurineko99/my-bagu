...
| * 16 | [#252](https://github.com/pyro-ppl/numpyro/issues/252) | bug | closed | [content]() | fori_collect does not work with non-float arrays  |  | Dimension/boundary-value | [Test]() |  18 Jul 2019 | committed on 30 Jul 2019 |
| * 17 | [#288](https://github.com/pyro-ppl/numpyro/issues/288) | bug、performance | closed | [content]() | mcmc is so slow with the new version of JAX |  | Dimension/boundary-value | [Test]() |  23 Aug 2019 | committed on 26 Aug 2019 |
| * 18 | [#553](https://github.com/pyro-ppl/numpyro/issues/552) | bug、question | closed | [content]() | "Cannot find valid initial parameters" after data size exceeds some threshold |  | Dimension/boundary-value | [Test]() |  3 Mar 2020 | committed on 6 Mar 2019 |
| * 19 | [#566](https://github.com/pyro-ppl/numpyro/issues/566) | bug | closed | [content]() | Predictive distribution fails on model with lax.scan |  | Dimension/boundary-value | [Test]() |  8 Apr 2020 | committed on 25 Jun 2020 |
| * 20 | [#691](https://github.com/pyro-ppl/numpyro/issues/691) | bug | closed | [content]() | Can't use jit_model_args for multi chains |  | Dimension/boundary-value | [Test]() |  24 Jul 2020 | committed on 25 Jul 2020 |
| * 21 | [#771](https://github.com/pyro-ppl/numpyro/issues/771) | bug | closed | [content]() | Omnistaging does not work when enabling distributions' validation |  | Dimension/boundary-value | [Test]() |  3 Oct 2020 | committed on 15 Oct 2020 |
| * 22 | [#779](https://github.com/pyro-ppl/numpyro/issues/779) | bug | closed | [content]() | Enumeration generates invalid dimensions at observation nodes |  | Dimension/boundary-value | [Test]() |  14 Oct 2020 | committed on 20 Oct 2020 |
| * 23 | [#820](https://github.com/pyro-ppl/numpyro/issues/820) | bug | closed | [content]() | Sample Tensorflow distributions with numpyro.sample() fail inside with handlers.seed(): statement |  | Dimension/boundary-value | [Test]() |  20 Nov 2020 | committed on 24 Nov 2020 |
| * 24 | [#1020](https://github.com/pyro-ppl/numpyro/issues/1020) | bug | closed | [content]() | Issue with AutoContinuous guides when using numpyro.deterministic |  | Dimension/boundary-value | [Test]() |  23 Apr 2021 | committed on 24 Apr 2021 |
| * 25 | [#1323](https://github.com/pyro-ppl/numpyro/issues/1323) | bug | closed | [content]() | Bayesian Hierarchical Stacking Example |  | Dimension/boundary-value | [Test]() |  5 Feb 2022 | committed on 9 Feb 2022 |
| * 26 | [#393](https://github.com/pyro-ppl/numpyro/issues/393) | bug | closed | [content]() | Investigate discrepancy in effective sample size computation |  | General numerical bugs | [Test]() |  9 Oct 2019 | committed on 10 Oct 2019 |
